...
from .combined_marker_phylogeny import (
    ...
    *,
    ...
    if eligible.size:
        retained_local = _complete_subset(
            supported_matrix[np.ix_(eligible, eligible)],
    ...
    retained_matrix = supported_matrix[np.ix_(retained, retained)]
    ...
    _write_matrix(matrix_path, sample_ids, combined)
    if retained_ids:
        tree_path.write_text(
    ...
    _copy_metadata_subset(metadata_path, metadata_output, set(sample_ids))
    return {
