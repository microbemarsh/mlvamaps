...
def run_short_read_call(
    ...
    mafft_bin: str = "mafft", raxml_ng_bin: str = "raxml-ng",
    epa_ng_bin: str = "epa-ng", raxml_model: str = "DNA",
    phylogeny_snp_weight: float = 1.0, phylogeny_repeat_weight: float = 1.0,
    reference_metadata_path: str | None = None,
    target_taxon_id: str | None = None, taxon_calibration_path: str | None = None,
    taxon_alpha: float | None = None, taxon_min_loci: int | None = None,
    taxon_min_locus_fraction: float = 0.8, taxon_bootstrap_replicates: int = 200,
    ...
    return run_mapping_short_read_call(
        ...
        short_consider_secondary=short_consider_secondary, mafft_bin=mafft_bin,
        ...
        taxon_minimum_margin=taxon_minimum_margin, show_progress=show_progress,
    )
