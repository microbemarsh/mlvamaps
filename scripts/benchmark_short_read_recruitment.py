...
from mlvamaps.repeat_likelihood import _motif_phases, _primitive_motif, _read_profile, flank_hit, repetitive
...
def benchmark(pairs, templates, threads):
    ...
    for function in (_motif_phases, _primitive_motif, _read_profile, flank_hit, repetitive):
